  ...
  <div class="card card--fire2 
    ...
    <div class="card-image">
      <div class="card-image-container">
        <img src="../../../static/flareon.png" width="450"/>
      </div>
    </div>
    <div class="card-content has-text-centered">
      <div class="main">
        <div class="title has-text-white">Flareon</div>
        <div class="hp">hp 65</div>
      </div>
      <div class="stats columns is-mobile">
        <div class="column">🔥<br>
          <span class="tag is-warning">Type</span>
        </div>
        <div class="column center-column">55.1 lbs<br>
          <span class="tag is-warning">Weight</span>
        </div>
        <div class="column">0.9 m <br>
