<template>
    <div class="card card--electric2
    has-text-weight-bold
    has-text-white">
        <div class="card-image">
            <div class="card-image-container">
                <img src="../../../static/zapdos.png"/>
            </div>
        </div>
        <div class="card-content has-text-centered">
            <div class="main">
                <div class="title has-text-white">Zapdos</div>
                <div class="hp">hp 90</div>
            </div>
            <div class="stats columns is-mobile">
                <div class="column">⚡<br />
                  <span class="tag is-warning">Type</span>
                </div>
                <div class="column center-column">116.0 lbs<br>
